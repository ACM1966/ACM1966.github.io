...
\begin{center}
  ...
  \footnotesize
  手机：153-0153-9901 \quad|\quad 邮箱：\href{mailto:diyuandeng@link.cuhk.edu.cn}{diyuandeng@link.cuhk.edu.cn} \quad|\quad 深圳 \quad|\quad \href{\Github}{GitHub}
\end{center}
\vspace{0.06em}
...
\begin{tabularx}{\linewidth}{@{}p{3.6em}Y@{}}
  ...
  \textbf{技术} & \textbf{Python}（精通）、\textbf{SQL}；C++、R、\textbf{UE5}；大模型推理（SGLang、并行与量化）；数据工程；tkinter/Qt。 \\[0.06em]
